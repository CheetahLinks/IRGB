...
function showResult() {
    ...
    colorScore.r1 = Math.round((score.r / (colorCounts.r)) * 255 / 100);
    colorScore.g1 = Math.round((score.g / (colorCounts.g)) * 255 / 100);
    colorScore.b1 = Math.round((score.b / (colorCounts.b)) * 255 / 100);
